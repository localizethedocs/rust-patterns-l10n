...
if (NOT VERSION_OF_MDBOOK_LAST_CHANGED STREQUAL "")
    set(CRATE_OF_MDBOOK_LAST_CHANGED "mdbook-last-changed@${VERSION_OF_MDBOOK_LAST_CHANGED}")
else()
    set(CRATE_OF_MDBOOK_LAST_CHANGED "mdbook-last-changed")
endif()
remove_cmake_message_indent()
message("")
message("VERSION_OF_MDBOOK              = ${VERSION_OF_MDBOOK}")
message("VERSION_OF_MDBOOK_I18N_HELPERS = ${VERSION_OF_MDBOOK_I18N_HELPERS}")
message("VERSION_OF_MDBOOK_LAST_CHANGED = ${VERSION_OF_MDBOOK_LAST_CHANGED}")
message("CRATE_OF_MDBOOK                = ${CRATE_OF_MDBOOK}")
message("CRATE_OF_MDBOOK_I18N_HELPERS   = ${CRATE_OF_MDBOOK_I18N_HELPERS}")
message("CRATE_OF_MDBOOK_LAST_CHANGED   = ${CRATE_OF_MDBOOK_LAST_CHANGED}")
message("")
execute_process(
